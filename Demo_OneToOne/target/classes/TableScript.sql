...
insert into customer values (1234,100,'james01@th.com', 'James', sysdate()-interval 7476 day);
insert into customer values (1235, 101,'william@th.com', 'William', sysdate()-interval 11374 day);
insert into customer values (1236, 102,'antony_04@th.com', 'Antony', sysdate()-interval 12344 day);
commit;
